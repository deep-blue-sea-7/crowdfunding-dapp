  ...
  return (
    <div className="flex md:flex-row flex-col-reverse justify-between mb-[35px] gap-6">
      <div className="lg:flex-1 flex flex-row max-w-[458px] py-2 pl-4 pr-2 h-[52px] bg-[#1c1c24] rounded-[100px]">
        ...
        <div className="w-[72px] h-full rounded-[20px] bg-[#5bccd2] flex justify-center items-center cursor-pointer">
      ...
      <div className="sm:flex hidden flex-row justify-end gap-4">
        <CustomButton
          ...
          styles={address ? "bg-[#0a619c]" : "bg-[#2b7ca4]"}
          handleClick={() => {
          ...
          <ul className="mb-4">
            {navlinks.map((link) => (
              ...
              >
                ...
                <p className={`ml-[20px] font-epilogue font-semibold text-[14px] ${isActive === link.name ? "text-[#5bccd2]" : "text-[#808191]"}`}>
                  {link.name}
                </p>
              </li>
            ))}
